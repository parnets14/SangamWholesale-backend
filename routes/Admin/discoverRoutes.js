...
router.route("/").get(getDiscoverItems)
.post(adminProtect, createDiscoverItem);

// Get, update, and delete a specific discover item
router
  .route("/:id")
  .get(adminProtect, getDiscoverItem)
  .put(adminProtect, updateDiscoverItem)
  .delete(adminProtect, deleteDiscoverItem);

// Like a discover item
router.route("/:id/like").post(adminProtect, likeDiscoverItem);
